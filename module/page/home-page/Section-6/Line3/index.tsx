    ...
    <div className="banner-line line-3">
      <div className="banner banner-1 ">
        ...
        <p className="description">
          Unlock incredible store building potential with an AJAX off-canvas
          cart, product quickview, advanced reviews, premium gallery styles,
          collapsable product widget area, and much more.
        </p>
        <CustomButton type={2} onClick={() => {}}>
          View All Feature
        </CustomButton>
        <div className={`img  ${animated && "animated"}`}>
          <Image
            src={
          ...
          <InView
            ...
            triggerOnce
            delay={200}
            onChange={(inView, entry) => setAnimated(inView)}
          >
